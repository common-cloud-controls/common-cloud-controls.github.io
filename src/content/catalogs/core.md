---
title: Core Catalog
description: The core catalog defines the baseline capabilities, threats, and controls that apply across all cloud service categories.
path: /catalogs/core
---

The core catalog is the foundation of the CCC framework. Where individual service catalogs cover the specifics of object storage, key management, or compute, the core catalog captures the cross-cutting concerns that apply universally — regardless of which cloud service is in scope.
