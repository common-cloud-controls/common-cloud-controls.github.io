...
path: "/catalogs/storage/object/controls/v2026.04-rc2"
---

# CCC Object Storage Controls

Version: v2026.04-rc2

_CCC Object Storage Controls_ is a Gemara v1.0.0-rc.2 ControlCatalog by FINOS Common Cloud Controls (Human, `FINOS-CCC`).
...
Controls whose group id is not listed in the catalog groups.
...
- **CCC.Core.Controls** — CCC Core Controls (vv2026.04-rc2)
